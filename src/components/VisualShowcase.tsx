        ...
        >
          <div className="relative order-2 lg:order-1">
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 w-72 h-72 bg-primary/30 rounded-full blur-3xl"></div>
              <img 
                src={womanPhone} 
                alt="Pessoa usando o app Rooda" 
                className="relative z-10 w-full max-w-2xl mx-auto drop-shadow-2xl rounded-3xl"
              />
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <Button 
              size="lg"
              className="bg-accent text-accent-foreground hover:bg-accent/90 font-bold text-lg px-10 py-6 rounded-xl shadow-lg"
            >
